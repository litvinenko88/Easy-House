...
const Features = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Полный контур эффективной минераловатной изоляции для комфортного микроклимата зимой и летом, а также отличной шумоизоляции и утепление",
    ...
    },
    {
      ...
      description:
        "Внутренняя отделка из натуральной сосны создает здоровый микроклимат и неповторимую атмосферу тепла и уюта модульного дома для жизни",
    ...
    },
    {
      ...
      description:
        "Надежный свайно-винтовой фундамент с обвязкой обеспечивает устойчивость дома на любом типе грунта без длительных подготовительных работ.",
    ...
    },
    {
      ...
      description:
        "Энергоэффективные трехкамерные окна сохраняют тепло, эффективно защищают от шума и позволяют экономить на отоплении живя с комфортом",
      ...
      <div className={styles.container} ref={containerRef}>
        <div>
          <h2 id="features-title" className={styles.sectionTitle}>
            Комплектация вашего модульного дома
          </h2>
        </div>

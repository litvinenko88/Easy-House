  ...
  const steps = [
    {
      ...
      desc: "Заранее подготавливаем площадку и фундамент (винтовые сваи) отличный выбор."
    },
    {
      icon: "🚛",
      title: "Доставка",
      desc: "Готовые модули аккуратно доставляются к участку упакованными на манипуляторе для круглогодичного проживания под ключ."
    },
    {
      icon: "🔧",
      title: "Монтаж",

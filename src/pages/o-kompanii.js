            ...
            <div className={styles.calloutContent}>
              ...
              <div className={styles.videoReviewsGrid}>
                <video className={styles.reviewVideo} controls preload="metadata">
                  <source src="/videos/otz1.mp4" type="video/mp4" />
                  Ваш браузер не поддерживает видео.
                </video>
                <video className={styles.reviewVideo} controls preload="metadata">
                  <source src="/videos/otz2.mp4" type="video/mp4" />
                  Ваш браузер не поддерживает видео.
                </video>
                <video className={styles.reviewVideo} controls preload="metadata">
                  <source src="/videos/otz3.mp4" type="video/mp4" />
                  Ваш браузер не поддерживает видео.
                </video>
                <video className={styles.reviewVideo} controls preload="metadata">
                  <source src="/videos/otz4.mp4" type="video/mp4" />
                  Ваш браузер не поддерживает видео.
                </video>
              </div>

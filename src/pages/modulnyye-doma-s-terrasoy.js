...
export default function ModularHomesWithTerrace() {
  ...
  return (
    <>
      ...
      <Layout
        title="Готовые модульные дома под ключ с террасой для круглогодичного проживания"
        description="Собственное производство модульных домов. Мы строим модульные дома под ключ для круглогодичного проживания. Наши быстровозводимые дома - это надежное и выгодное решение. Выберите индивидуальную планировку или типовой проект. Строительство модульных домов с гарантией качества. Получите готовый дом под ключ в кратчайшие сроки! Модульный дом — это ваш комфорт и уют"
        keywords="модульный дом с террасой, дом под ключ, купить модульный дом, быстровозводимый дом, модульные дома под ключ, строительство модульных домов, дом для круглогодичного проживания, готовые модульные дома, производство модульных домов, модульный дом цена">
        <Hero
          title={
            <>

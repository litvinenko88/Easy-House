  ...
  return (
    <Layout
      ...
      <ProblemSolution
        ...
        solutions={[
          "Только своя бригада",
          "Дома, адаптированные под климат Республики КЧР",
          "Фиксированная цена",
      ...
      <WhyChooseUs 
        ...
        subtitle="Современная технология строительства открывает новый стандарт комфорта, надежности и экономии"
        advantages={[
          {
            id: 1,
            title: "Быстрое строительство",
            description: "Полный цикл работ от фундамента до вручения ключей занимает 30 дней. Установка конструкции на участке — всего 1-2 дня, что ускоряет реализацию вашего проекта.",
            icon: "⚡",
            color: "#FF6B35"
          },
          {
            id: 2,
            title: "Честная цена",
            description: "Стоимость модульного дома фиксируется до начала работ и остаётся неизменной. Никаких скрытых платежей и неприятных сюрпризов.",
            icon: "💰",
            color: "#4ECDC4"
          },
          {
            ...
            description: "Сборка возможна в любой сезон благодаря заводскому изготовлению модулей, которое не зависит от внешних условий и использует проверенные материалы.",
            icon: "🌦️",
            color: "#45B7D1"
          },
          {
            ...
            description: "Многослойные теплоизолированные панели и герметичность конструкции позволяют экономить до 50% на обогреве зимой и охлаждении летом. Все затраты на отопление прогнозируемы.",
            icon: "🔥",
            color: "#96CEB4"
          },
          {
            ...
            description: "Все компоненты изготавливаются на современном оборудовании в идеальных условиях, что минимизирует ошибки и влияние человеческого фактора.",
            icon: "⚙️",
            color: "#FFEAA7"
          },
          {
            ...
            description: "Каркас из сухого дерева и двутавровых балок не подвержен усадке, сохраняет геометрию и служит годами. Модульные дома для постоянного проживания не уступают капитальным постройкам.",
            icon: "🏠",
            color: "#DDA0DD"
          }
        ]}
        ...
        guarantees={[
          {
            ...
            description: "Мы отвечаем за конструкцию, отделку и коммуникации. При возникновении любых вопросов — быстро приедем и устраним неисправности.",
            icon: "🛡️"
          },
          {
            id: 2,
            title: "Фиксированная стоимость в договоре",
            description: "Проект и цены модульного дома остаются неизменными после подписания договора, а стоимость доставки указывается предварительно. Никаких скрытых сборов или переплат за «непредвиденные ситуации», независимо от погодных условий.",
            icon: "💰"
          },
          {
            id: 3,
            title: "Соблюдение agreed сроков",
            description: "За каждый день задержки, оговорённой в договоре, мы компенсируем неустойку в размере 0,1% от стоимости работ.",
            icon: "⏰"
          },
          {
            id: 4,
            title: "Открытая отчётность",
            description: "Вы будете регулярно получать фото- и видеоотчёты о процессе производства и строительства вашего дома. Вы всегда в курсе прогресса работ.",
            icon: "📊"
          },
          {
            id: 5,
            title: "Прозрачная документация",
            description: "Заключаем официальный договор, детально прописываем все этапы, спецификации и условия. Вы юридически защищены при заказе модульного дома напрямую от производителя.",
            icon: "📋"
          }
        ]}
        ...
        steps={[
          {
            ...
            description: "Заблаговременно подготавливаем площадку и фундамент (винтовые сваи) — оптимальное решение."
          },
          {
            icon: "🚛",
            title: "Транспортировка",
            description: "Готовые модули бережно доставляются к месту назначения в защитной упаковке с помощью манипулятора для постоянного проживания под ключ."
          },
          {
            icon: "🔧",
            title: "Сборка",
            description: "Собираем дом по принципу конструктора за 1-2 дня с применением профессионального оборудования."
          },
          {
            icon: "⚡",
            title: "Подключение коммуникаций",
            description: "Устанавливаем и подключаем все инженерные системы: электроснабжение, отопление, водопровод, используя исключительно качественные материалы."
          },
          {
            icon: "✨",
            title: "Уборка",
            description: "После завершения работ полностью удаляем весь строительный мусор."
          }
        ]}
